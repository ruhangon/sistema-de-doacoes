...
public class DbService {
	...
	public void inicializaBancoDeDados() throws ParseException {
		...
		Doacao d1 = new Doacao(1,"Doa-se Cachorro","Categoria1","caminho da imagem","Disponível","Recebedor Paga o Frete","Chachorro encomoda muito não dá mais",null,u2,u1);
		Doacao d2 = new Doacao(2,"Doa-se Vaca","Categoria2","caminho da imagem","Disponível","Doador Paga o Frete","Leite Azedo",null,u1,u2);
		Doacao d3 = new Doacao(3,"Doa-se Leitão","Categoria2","caminho da imagem","Disponível","Doador Paga o Frete","Leite Azedo",null,u1,null);
		Doacao d4 = new Doacao(4,"Doa-se Bezerro","Categoria2","caminho da imagem","Disponível","Doador Paga o Frete","Leite Azedo",null,u1,null);
		Doacao d5 = new Doacao(5,"Doa-se Bode","Categoria3","caminho da imagem","Disponível","Doador Paga o Frete","Leite Azedo",null,u2,null);
		Doacao d6 = new Doacao(6,"Doa-se Hipopotamo","Categoria4","caminho da imagem","Disponível","Doador Paga o Frete","Leite Azedo",null,u2,u1);
		
		
		d1.setStatus("Finalizada");
		d2.setStatus("Finalizada");
